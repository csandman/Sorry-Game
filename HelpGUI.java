	...
	public class MyAction implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			JOptionPane.showMessageDialog(null,
					"OBJECTIVE: The First Player to get all four of your pawns from your color START to your color HOME."
	...
	public class MyAction2 implements ActionListener {
		public void actionPerformed(ActionEvent ae) {
			JOptionPane.showMessageDialog(null, "1: Either start a pawn out OR move one pawn forward 1 space."
					...
					+ "\nSORRY!: Take one pawn from your START, place it on any space that is occupied by any opponent, and bump that opponent's pawn back to its START. If there is no pawn on you START or no opponent's pawn on any space you can move to, you forfeit your move.",
					"Card Instructions", 1);
		}
	}
