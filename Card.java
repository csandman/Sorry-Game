...
class Card
{
   /**create main method card @param int
   this int can be from 1-12*/
   //take in int
   ...
   /**
      ...
      of the card data. Use this
      to find the image that goes with
      the card...**we may end up not using this**
      @return card.
     */
