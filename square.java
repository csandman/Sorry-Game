...
public class square {
	...
	private int location; // 0-59 normal tiles, 101-105 yellow safe zone, 106-109 yellow end zone, 111-114
							// yellow start etc...
	private String color; // color: yellow, green, red, blue
	private Pawn pawn;

	// public enum squareType {invalid, reg, triangle, end, slide, color, home,
	// start}
...
/*
 * public void setPawn(Pawn p){ square.p = p; }
 * 
 * public boolean checkPawn(){ return checkPawn; }
 * 
 * 
 * public static boolean hasPawn(){ //needs to be changed if (checkPawn = true){
 * System.out.println("This square has a pawn"); } else{
